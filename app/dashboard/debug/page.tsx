...
export default function DebugPage() {
  ...
  return (
    <div className="container py-6 md:py-10 space-y-6 max-w-full">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Debug Dashboard</h1>
        <p className="text-muted-foreground">
          This page provides comprehensive debugging information about your application state.
        </p>
      </div>
      ...
      <Tabs defaultValue="session" className="w-full">
        ...
        <TabsContent value="client" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Globe className="h-5 w-5" /> Browser Information
                </CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="text-xs break-all">{browserInfo?.userAgent}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Platform</TableCell>
                      <TableCell>{browserInfo?.platform}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Language</TableCell>
                      <TableCell>{browserInfo?.language}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Timezone</TableCell>
                      <TableCell>{browserInfo?.timezone}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Screen</TableCell>
                      <TableCell>{browserInfo?.screenWidth} x {browserInfo?.screenHeight} ({browserInfo?.pixelRatio}x)</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Online</TableCell>
                      <TableCell>{browserInfo?.online ? "Yes" : "No"}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Cookies</TableCell>
                      <TableCell>{browserInfo?.cookieEnabled ? "Enabled" : "Disabled"}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Do Not Track</TableCell>
                      <TableCell>{browserInfo?.doNotTrack || "Not Set"}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-medium">Storage</TableCell>
                      <TableCell>
                        LocalStorage: {browserInfo?.localStorage ? "Available" : "Unavailable"}, 
                        SessionStorage: {browserInfo?.sessionStorage ? "Available" : "Unavailable"}
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Shield className="h-5 w-5" /> Network & Security
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <div className={`w-3 h-3 rounded-full ${browserInfo?.online ? 'bg-green-500' : 'bg-red-500'}`}></div>
                      <div className="font-medium">
                    ...
                    <Table>
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>{window.location.protocol === 'https:' ? "Yes" : "No"}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="font-medium">Secure Context</TableCell>
                          <TableCell>{window.isSecureContext ? "Yes" : "No"}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="font-medium">Cookies</TableCell>
                          <TableCell>{document.cookie ? `${document.cookie.split(';').length} cookies set` : "No cookies"}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="font-medium">Authentication</TableCell>
                          <TableCell>{status === "authenticated" ? "Authenticated" : "Not Authenticated"}</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </div>
        ...
        <TabsContent value="performance" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Sparkles className="h-5 w-5" /> Optimizations
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <h3 className="font-medium mb-2">Performance Suggestions</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <div className="w-4 h-4 rounded-full bg-yellow-400 mt-0.5 flex-shrink-0"></div>
                        <span>Implement image lazy loading for improved performance</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-4 h-4 rounded-full bg-green-500 mt-0.5 flex-shrink-0"></div>
                        <span>Using Next.js Image optimization</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-4 h-4 rounded-full bg-yellow-400 mt-0.5 flex-shrink-0"></div>
                        <span>Consider implementing server-side caching</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-4 h-4 rounded-full bg-green-500 mt-0.5 flex-shrink-0"></div>
                        <span>Using React component memoization</span>
                      </li>
                    </ul>
                  </div>
                  
                  <div>
                    <h3 className="font-medium mb-2">Browser Features</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <div className={`w-4 h-4 rounded-full ${window.localStorage ? 'bg-green-500' : 'bg-red-500'} mt-0.5 flex-shrink-0`}></div>
                        <span>Local Storage</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className={`w-4 h-4 rounded-full ${window.sessionStorage ? 'bg-green-500' : 'bg-red-500'} mt-0.5 flex-shrink-0`}></div>
                        <span>Session Storage</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className={`w-4 h-4 rounded-full ${navigator.serviceWorker ? 'bg-green-500' : 'bg-red-500'} mt-0.5 flex-shrink-0`}></div>
                        <span>Service Worker API</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className={`w-4 h-4 rounded-full ${window.indexedDB ? 'bg-green-500' : 'bg-red-500'} mt-0.5 flex-shrink-0`}></div>
                        <span>IndexedDB</span>
                      </li>
                    </ul>
                  </div>
        ...
        <TabsContent value="logs" className="space-y-4">
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="flex items-center gap-2">
                  <Terminal className="h-5 w-5" /> Application Logs
                </CardTitle>
                <div className="flex gap-2">
                  ...
                  <Button 
                    ...
                    size="sm"
                    onClick={() => {
                      addLogEntry('Manual log entry added');
                    }}
                  >
                    Add Test Log
                  </Button>
        ...
        <TabsContent value="tools" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                <CardTitle>Session & Auth Tools</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 gap-2">
                  <Button variant="outline" onClick={refreshSession} className="justify-start">
                  ...
                  <Button variant="outline" onClick={() => {
                    ...
                    addLogEntry('Auth tokens cleared from storage');
                  }} className="justify-start">
                    <Shield className="mr-2 h-4 w-4" /> Clear Auth Tokens
                  </Button>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Storage Tools</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 gap-2">
                  <Button variant="outline" onClick={() => {
                    ...
                    <History className="mr-2 h-4 w-4" /> Clear Local Storage
                  </Button>
                  <Button variant="outline" onClick={() => {
                    sessionStorage.clear();
                    toast.success("Session storage cleared");
                    addLogEntry('Session storage cleared');
                  }} className="justify-start">
                    <History className="mr-2 h-4 w-4" /> Clear Session Storage
                  </Button>
                  <Button variant="outline" onClick={clearAllCookies} className="justify-start">
                    <History className="mr-2 h-4 w-4" /> Clear Cookies
                  </Button>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-2">
                  <Button variant="outline" onClick={() => {
                    location.reload();
                    addLogEntry('Page reload triggered');
                  }} className="justify-start">
                    <RefreshCw className="mr-2 h-4 w-4" /> Reload Page
                  </Button>
                  <Button variant="outline" onClick={() => {
                    window.open('/dashboard', '_blank');
                    addLogEntry('Opened dashboard in new window');
                  }} className="justify-start">
                    <Cpu className="mr-2 h-4 w-4" /> Open in New Window
                  </Button>
                </div>
              </CardContent>
            </Card>
